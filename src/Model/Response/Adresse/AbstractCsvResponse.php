...
abstract class AbstractCsvResponse extends AdressesResponse {
    ...
    public static function enumResultColumns(): array {
        return [
            static::RESULT_CITY,
            static::RESULT_CITYCODE,
            static::RESULT_CONTEXT,
            static::RESULT_DISTANCE,
            static::RESULT_DISTRICT,
            static::RESULT_HOUSENUMBER,
            static::RESULT_ID,
            static::RESULT_LABEL,
            static::RESULT_LATITUDE,
            static::RESULT_LONGITUDE,
            static::RESULT_NAME,
            static::RESULT_OLDCITY,
            static::RESULT_OLDCITYCODE,
            static::RESULT_POSTCODE,
            static::RESULT_SCORE,
            static::RESULT_STREET,
            static::RESULT_TYPE,
        ];
    }
}